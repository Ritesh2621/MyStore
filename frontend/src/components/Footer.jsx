...
const Footer = () => {
  ...
  return (
    <>
      <div className="bg-gray-800 text-white py-8 px-4 mt-auto">
          ...
          <div className="md:hidden">
            ...
            <div className="border-b border-gray-700 py-2">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${expandedSections.shop ? 'transform rotate-180' : ''}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
            ...
            <div className="border-b border-gray-700 py-2">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${expandedSections.support ? 'transform rotate-180' : ''}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
            ...
            <div className="border-b border-gray-700 py-2">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${expandedSections.company ? 'transform rotate-180' : ''}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
  ...
  <Link to="/" className="text-gray-300 hover:text-white">About Us</Link>
            ...
            <div className="py-4">
              ...
              <p className="text-gray-300 mb-3">Get updates on new products and sales</p>
              <div className="flex flex-col sm:flex-row">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="px-4 py-2 rounded-md sm:rounded-l-md sm:rounded-r-none w-full mb-2 sm:mb-0 focus:outline-none text-gray-800"
                />
                <button className="bg-indigo-600 px-4 py-2 rounded-md sm:rounded-l-none sm:rounded-r-md hover:bg-indigo-700">
                  Subscribe
                </button>
              </div>
            </div>
