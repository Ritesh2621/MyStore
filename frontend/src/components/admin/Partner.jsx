...
//     try {
//       await axios.post('http://localhost:4000/admin/add-vendor', newPartner);
  ...
  return (
    <Box sx={{ py: 3, px: { xs: 1, sm: 3, md: 5 } }}>
              ...
              <Table sx={{ minWidth: 300 }}>
                <TableHead>
                  <TableRow sx={{ bgcolor: 'primary.light' }}>
                    ...
                    <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>Phone</TableCell>
                    <TableCell
                      sx={{ fontWeight: 'bold', color: 'white', width: { xs: 80, sm: 120 } }}
                      align="center"
                    >
                      Actions
                    </TableCell>
      ...
      <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete partner "{partnerToDelete?.name}"?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setOpenDeleteDialog(false)} color="inherit">Cancel</Button>
          <Button onClick={handleDeletePartner} color="error">Delete</Button>
        </DialogActions>
      </Dialog>
